...
import sty from "./PlasmicAlert.module.css"; // plasmic-import: eNIe_F0JX4g7/css

import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: JTdnCel_vAnL/icon
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hGola, {
          [sty.freeBoxnoBody__hGolaYaozT]: hasVariant(
            $state,
            "noBody",
            "noBody"
          ),
          [sty.freeBoxnoHeader__hGolasn2NR]: hasVariant(
            $state,
            "noHeader",
            "noHeader"
          ),
          [sty.freeBoxnoIcon__hGola5Ed7T]: hasVariant(
            $state,
            "noIcon",
            "noIcon"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__aC6D, {
            [sty.freeBoxnoIcon__aC6D5Ed7T]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__iv6X)}
                role={"img"}
              />
            ),
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__eqM4S, {
            [sty.freeBoxnoHeader__eqM4Ssn2NR]: hasVariant(
              $state,
              "noHeader",
              "noHeader"
            ),
            [sty.freeBoxnoIcon__eqM4S5Ed7T]: hasVariant(
              $state,
              "noIcon",
              "noIcon"
            )
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__dGkhV, {
              [sty.freeBoxnoBody__dGkhVYaozT]: hasVariant(
                $state,
                "noBody",
                "noBody"
              ),
              [sty.freeBoxnoHeader__dGkhVsn2NR]: hasVariant(
                $state,
                "noHeader",
                "noHeader"
              )
