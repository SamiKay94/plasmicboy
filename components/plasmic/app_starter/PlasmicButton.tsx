...
import sty from "./PlasmicButton.module.css"; // plasmic-import: xhwhDmE_bDks/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: lFMrC6oBAKkT/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: QsGWy_yx7pqg/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__w4BW)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__gqhcm)}
                role={"img"}
              />
            ),
