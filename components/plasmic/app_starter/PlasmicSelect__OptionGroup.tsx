...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _jVslpxaXO1m/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: AAXjijoJv_L9/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__iMJl4)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___4YlzG)}
              />
            </React.Fragment>
          ),
          value: args.children
