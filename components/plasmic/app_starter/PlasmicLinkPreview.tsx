...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: auEbhZIKcHBZ/css
...
function PlasmicLinkPreview__RenderFunc(props: {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox__x0BW4)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__k0K1P)}>
              <div className={classNames(projectcss.all, sty.freeBox___8MDpw)}>
                <h5
